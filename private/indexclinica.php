...
<head>
    ...
    <title>BioLance | Painel Clínico</title>
...
<body>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    <div class="profile-dropdown" data-bs-toggle="dropdown">
                        ...
                        <span class="profile-email" id="userEmail">usuario@clinicabiolance.com</span>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-section">
            <h6 class="sidebar-section-title">Painel Clínico</h6>
            <a href="#" class="menu-item active">
                <i class="fas fa-home"></i>
                <span>Visão Geral</span>
            </a>
            
            <div class="menu-item menu-toggle collapsed" data-bs-toggle="collapse" data-bs-target="#clientesMenu">
                <span>
                    <i class="fas fa-users"></i>
                    <span>Clientes</span>
                </span>
            </div>
            <div class="submenu collapse" id="clientesMenu">
            ...
            <div class="menu-item menu-toggle collapsed" data-bs-toggle="collapse" data-bs-target="#contactosMenu">
                <span>
                    <i class="fas fa-address-book"></i>
                    <span>Lista de Contactos</span>
                </span>
            </div>
            <div class="submenu collapse" id="contactosMenu">
                <a href="#" class="menu-item submenu-item">
                    <i class="fas fa-hospital"></i>
                    <span>Clínicas do Grupo</span>
                </a>
                <a href="#" class="menu-item submenu-item">
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-subtext">Próximo: 10:30</div>
            </div>
            
            <div class="stat-card">
                <div class="stat-value">15</div>
                <div class="stat-label">Agendamentos</div>
                <div class="stat-subtext">3 Urgentes</div>
            </div>
            
            <div class="stat-card">
                <div class="stat-value">8</div>
                <div class="stat-label">Laboratórios</div>
                <div class="stat-subtext">Parceiros</div>
            </div>
    ...
    <script>
        ...
        document.getElementById('userEmail').textContent = localStorage.getItem('userEmail') || 'usuario@clinicabiolance.com';
